...
final class EmbeddedCssFontFaceTest extends TestCase
{
    public function testBase64EmbeddedFontFaceParticipatesInTextMeasurement(): void
    {
        $fontData = base64_encode($this->fontFixture());
        $html = '<style>'
            . '@font-face {'
            . 'font-family:"EmbeddedFixture";'
            . 'src:url("data:font/ttf;base64,' . $fontData . '") format("truetype");'
            . 'font-weight:400;'
            . 'font-style:normal;'
            . '}'
            . 'p { margin:0; font-family:"EmbeddedFixture"; font-size:10px; }'
            . '</style><p>AB</p>';
